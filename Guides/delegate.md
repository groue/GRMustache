...
As soon as an object enters the [context stack](runtime.md#the-context-stack), all its methods, properties, and generally speaking, value returned by the `valueForKey:` method are available for the templates (see the [Runtime Guide](runtime.md)).
